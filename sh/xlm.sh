...
# python py/rsi.py reverse --source=$file_path --window=6 --offset=-0.001 --desired=60,55,54,53,52,51,50,45,40,35

python py/processor.py process --source=$file_path --output=$ta_file_path
python py/backtest.py compute --source=$ta_file_path --output=$backtest_file_path --tail=1000
