...
# offset="$3"
# if [[ -n "$offset" ]]; then
#     python py/rsi.py reverse --source=$file_path --window=9 --offset=$offset --desired=80,85,87,90 --price_type=high
#     python py/rsi.py reverse --source=$file_path --window=9 --offset="-$offset" --desired=20,15 --price_type=low
# fi